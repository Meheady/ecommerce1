                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="text-center">All Unit</h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                            ...
                                            @foreach($units as $unit)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('edit-unit',['id'=>$unit->id]) }}" class="btn btn-success">Edit</a>
                                                        <a href="{{ route('delete-unit',['id'=>$unit->id]) }}" class="btn btn-danger">Del</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
