                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                            ...
                                            @foreach( $subCategories as $subCategory)
                                                <tr>
                                                    ...
                                                    <td><img src="{{asset($subCategory->image)  }}" width="50px" height="50px" alt=""></td>
                                                    <td>{{ $subCategory->status==1? 'Active':'Deactive' }}</td>
                                                    <td><a href="{{ route('edit-subcategory',['id'  =>$subCategory->id]) }}" class="btn btn-success">Edit</a>
                                                        <a href="{{ route('delete-subcategory',['id'=>$subCategory->id]) }}" onclick="return confirm('Are Your sure')" class="btn btn-danger">Delete</a></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
