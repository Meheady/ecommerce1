                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                            ...
                                            @foreach($brands as $brand)
                                                <tr>
                                                    ...
                                                    <td> <img src="{{ asset($brand->image) }}" width="50px" height="50px" alt=""></td>
                                                    <td>{{ $brand->status == 1 ? "active": "inactive" }}</td>
                                                    <td>
                                                        <a href="{{ route('edit-brand',['id'=>$brand->id]) }}" class="btn btn-success">Edit</a>
                                                        <a href="{{ route('delete-brand',['id'=>$brand->id]) }}" class="btn btn-danger">Del</a>
                                                        <a href="{{ route('brand-detail',['id'=>$brand->id]) }}">View details</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
